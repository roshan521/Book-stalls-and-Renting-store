            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="col-12 text-center">
                        <h1 class="page-title">Old Book</h1>
                        <ul class="breadcrumb justify-content-center">
                            <li><a href="index.php">Home</a></li>
                            <li class="current"><span>oldbook</span></li>
                        </ul>
                    </div>
                </div>
            </div>
                                ...
                                <div class="shop-toolbar__inner">
                                    <div class="row align-items-center">
                                        <div class="col-md-6 text-md-left text-center mb-sm--20">
                                            ...
                                            <p class="product-pages text-white p-3 bg-primary font-size-15">Total Old Books:
                                                <span>
                                                    <?php 
                                                    include('config.php');
                                        ...
                                        <div class="col-md-6">     
                                                <div class="product-ordering">
                                                    <a href="submitoldbook.php" class="bg-success font-size-20 text-white text-center shop-toolbar__btn">
                                                        <span>Click Here To Submit Old Book</span>
                                                        <i></i>
                                                    </a>
                                            ...
                                            <div class="product-inner">
                                                <figure class="product-image">
                                                    <div class="product-image--holder">
                                                        <a href="product-details-old.php?itemno=<?php echo $row['old_id']; ?>">
                                                    ...
                                                    <div class="airi-product-action">
                                                        ...
                                                        <a class="quickview-btn action-btn" href="product-details-old.php?itemno=<?php echo $row['old_id']; ?>"
                                                            ...
                                                            <!-- <a class="add_to_cart_btn action-btn" href="addtocart.php?itemno=<?php echo $row['old_id'];?>"
                                                ...
                                                <div class="product-info text-center">
                                                    <h3 class="product-title">
                                                        <a href="product-details-old.php?itemno=<?php echo $row['old_id']; ?>"><?php echo $row['oldbook'].' by';?></a>
                                                    </h3>
                                                    <h3 class="product-title">
                                                        <a href="product-details-old.php?itemno=<?php echo $row['old_id']; ?>"><?php echo $row['Author'];?></a>
                                                    </h3>
