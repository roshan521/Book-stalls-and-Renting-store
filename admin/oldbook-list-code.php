...
if(isset($_POST['oldbook_save']))
{
    ...
    if(isset($_FILES['fileToUpload']))
     ...
     $query = "INSERT INTO nbook(oldbook,Branch,Sem,Author,PublicationHouse,description,Price,image) VALUES ('$bname','$branch','$sem','$author','$publisher','$description','$price','$file_name')";
            ...
            if($query_run)
            {
                ...
                header('Location: oldbook-list.php');
            }
            else 
            {
...
$file_size=$_FILES['fileToUpload']['size'];
    ...
    $query1 = "UPDATE obook
     SET  oldbook='$edit_bname',Branch='$edit_branch',Sem='$edit_sem',Author='$edit_author',PublicationHouse='$edit_publisher',Price='$edit_price',image='$file_name' WHERE  old_id='$id'";
