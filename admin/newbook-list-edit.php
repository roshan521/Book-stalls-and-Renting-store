    ...
    <div class="card shadow mb-4">
        ...
        <?php
            ...
            if(isset($_POST['edit_btn']))
            {
                ...
                $query = "SELECT * FROM nbook WHERE new_id='$id'";
                    ...
                    ?>
                        ...
                        <form action="newbook-list-code.php" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="edit_bname" value="<?php echo $row['newbook'] ?>" class="form-control"
                            ...
                            <a href="newbook-list.php" class="btn btn-danger"> CANCEL </a>
