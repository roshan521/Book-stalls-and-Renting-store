            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="col-12 text-center">
                        <h1 class="page-title">Third Semester</h1>
                        <ul class="breadcrumb justify-content-center">
                            <li><a href="index.php">Home</a></li>
                            <li class="current"><span>Third-Sem</span></li>
                        </ul>
                    </div>
                </div>
            </div>
                        ...
                        <div class="col-lg-9 order-lg-2" id="main-content">
                                    ...
                                    <div class="row align-items-center">
                                        <div class="col-md-6 text-md-left text-center mb-sm--20">
                                            <div class="shop-toolbar__left">
                                                <p class="product-pages text-white p-3 bg-primary font-size-15">Total Third Sem Books:
                            ...
                            <div class="shop-products">
                                <div class="row grid-space-20 xxl-block-grid-5">
                                            <?php
                                                include('config.php');
                                                $query = "SELECT * FROM nbook where Sem='3'  LIMIT 6";
                                                $query_run = mysqli_query($connection, $query);
